    ...
    <div className="h-full flex flex-col min-h-0 gap-4 animate-fade-up">
      <div className="flex items-center justify-between shrink-0 mb-2">
        ...
        <div className="flex items-center gap-3">
          <div className="relative group">
            <select
              className="appearance-none bg-white/5 border border-white/10 rounded-xl pl-4 pr-10 py-2 text-sm font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500/40 hover:bg-white/10 transition-all cursor-pointer min-w-[200px]"
            ...
            >
              <option value="" className="bg-zinc-900">Select repository</option>
              {repos.map((repo) => (
                <option
      ...
      <div className="flex-1 min-h-0">
        {selectedRepo ? (
          ...
          <div className="h-full flex flex-col items-center justify-center gap-6 border border-dashed border-white/10 rounded-3xl bg-white/2 animate-pulse">
            <div className="size-16 rounded-3xl bg-white/5 flex items-center justify-center border border-white/10">
              <MessageSquare className="size-8 text-white/20" strokeWidth={1.5} />
            </div>
