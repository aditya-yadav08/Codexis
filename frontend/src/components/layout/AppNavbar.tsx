  ...
  return (
    <header className="h-14 border-b border-white/8 glass flex items-center gap-3 px-4 md:px-6 shrink-0">
      ...
      <Button
        ...
        variant="ghost"
        size="icon"
        className="md:hidden size-8 text-muted-foreground hover:text-foreground hover:bg-white/8 rounded-lg"
      ...
      <div className="flex-1 flex items-center min-w-0">
        <div className="w-full max-w-md relative">
          ...
          <Input
            ...
            className="pl-9 pr-14 h-9 rounded-xl bg-white/6 border-white/10 text-sm placeholder:text-muted-foreground/60 focus-visible:ring-indigo-500/50 focus-visible:border-indigo-500/40"
          />
          <kbd className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 inline-flex items-center gap-0.5 rounded-md border border-white/10 bg-white/6 px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">
            ⌘K
          </kbd>
        </div>
      </div>
